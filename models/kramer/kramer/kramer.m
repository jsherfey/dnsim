...
spec.connections(1,2).parameters = {'g_SYN',gei,'E_SYN',0,'tauDx',1,'tauRx',.25,'fanout',inf,'IC_noise',.01};
spec.connections(1,3).label = 'RS-LTS';
spec.connections(1,3).mechanisms = {'RS_LTS_iSYN'};
spec.connections(1,3).parameters = {'g_SYN',geL,'E_SYN',0,'tauDx',1,'tauRx',2.5,'fanout',inf,'IC_noise',.01};
spec.connections(2,1).label = 'B-RS';
spec.connections(2,1).mechanisms = {'B_RS_iSYN'};
spec.connections(2,1).parameters = {'g_SYN',gie,'E_SYN',-80,'tauDx',5,'tauRx',.5,'fanout',inf,'IC_noise',0};
spec.connections(2,2).label = 'B-B';
spec.connections(2,2).mechanisms = {'B_B_iSYN'};
spec.connections(2,2).parameters = {'g_SYN',gii,'E_SYN',-75,'tauDx',5,'tauRx',.5,'fanout',inf,'IC_noise',0};
spec.connections(2,3).label = 'B-LTS';
spec.connections(2,3).mechanisms = {'B_LTS_iSYN'};
spec.connections(2,3).parameters = {'g_SYN',giL,'E_SYN',-80,'tauDx',6,'tauRx',.5,'fanout',inf,'IC_noise',.01};
spec.connections(3,1).label = 'LTS-RS';
spec.connections(3,1).mechanisms = {'LTS_RS_iSYN'};
spec.connections(3,1).parameters = {'g_SYN',gLe,'E_SYN',-80,'tauDx',20,'tauRx',.5,'fanout',inf,'IC_noise',.01};
spec.connections(3,3).label = 'LTS-LTS';
spec.connections(3,3).mechanisms = {'LTS_LTS_iSYN'};
spec.connections(3,3).parameters = {'g_SYN',gLL,'E_SYN',-80,'tauDx',20,'tauRx',.5,'fanout',inf,'IC_noise',.01};
spec.connections(3,4).label = 'LTS-IBda';
spec.connections(3,4).mechanisms = {'LTS_IBda_iSYN'};
spec.connections(3,4).parameters = {'g_SYN',gLd,'E_SYN',-80,'tauDx',20,'tauRx',.5,'fanout',inf,'IC_noise',.01};
