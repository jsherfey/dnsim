...
epoch_data.epochs.num_trials          = ntrl;
epoch_data.epochs.num_rejects.mag     = 0;
epoch_data.epochs.num_rejects.grad    = 0;
epoch_data.epochs.num_rejects.eeg     = 0;
epoch_data.epochs.num_rejects.eog     = 0;
epoch_data.epochs.num_rejects.manual  = 0;
epoch_data.epochs.num_rejects.skip    = 0;
epoch_data.epochs.time                = t;
epoch_data.epochs.data                = y;
